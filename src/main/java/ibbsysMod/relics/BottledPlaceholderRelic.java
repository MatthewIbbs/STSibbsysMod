...
import ibbsysMod.patches.relics.BottledPlaceholderField;
import ibbsysMod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static ibbsysMod.DefaultMod.makeRelicOutlinePath;
import static ibbsysMod.DefaultMod.makeRelicPath;
